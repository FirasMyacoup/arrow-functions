...
// the this value is set to global variable
// 2. What is "this" when joe.scopeArrow() is invoked?
//  inherit the one from the parent scope
// 3. Explain why "this" is different when an arrow function is used.
// The context in which the function is invoked determines the value that the this keyword is bound to. In contrast, arrow functions make use of this's value within their lexical scope.
// Because of this, It behave extremely differently.